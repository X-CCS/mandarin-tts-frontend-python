# reference: https://github.com/lturing/tacotronv2_wavernn_chinese #

import re
import os

toneMap = {"ā": "a1", "á": "a2", "ǎ": "a3", "à": "a4", "ō": "o1", "ó": "o2", "ǒ": "o3", "ò": "o4", "ē": "e1", "é": "e2", "ě": "e3", "è": "e4",
           "ī": "i1", "í": "i2", "ǐ": "i3", "ì": "i4", "ū": "u1", "ú": "u2", "ǔ": "u3", "ù": "u4", "ü": "v0", "ǖ": "v1", "ǘ": "v2", "ǚ": "v3", "ǜ": "v4", "ń": "n2", "ň": "n3", "": "m2"}
...
def tone_to_digit(pyin):
    for i in range(len(pyin)):
        if pyin[i] in toneMap:
            pyin = pyin[:i] + toneMap[pyin[i]][0] + \
                pyin[i+1:] + toneMap[pyin[i]][1]
            break
